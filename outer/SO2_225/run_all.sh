...
sander -O -i md_inputs/3_production.in -o md_outputs/3_production.out -p md_inputs/water_solvated.prmtop -c checkpoints/3_eq.rst -r checkpoints/3_production.rst -x ptraj/production.mdcrd
